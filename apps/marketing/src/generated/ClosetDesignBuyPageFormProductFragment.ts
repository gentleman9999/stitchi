...
export interface ClosetDesignBuyPageFormProductFragment_variants_edges_node_options_edges_node_values {
   ...
   * A list of edges.
   */
  edges: (ClosetDesignBuyPageFormProductFragment_variants_edges_node_options_edges_node_values_edges | null)[] | null;
}
...
export interface ClosetDesignBuyPageFormProductFragment_variants_edges_node_options {
   ...
   * A list of edges.
   */
  edges: (ClosetDesignBuyPageFormProductFragment_variants_edges_node_options_edges | null)[] | null;
}
...
export interface ClosetDesignBuyPageFormProductFragment_productOptions_edges_node_MultipleChoiceOption_values {
   ...
   * A list of edges.
   */
  edges: (ClosetDesignBuyPageFormProductFragment_productOptions_edges_node_MultipleChoiceOption_values_edges | null)[] | null;
}
...
export type ClosetDesignBuyPageFormProductFragment_productOptions_edges_node = ClosetDesignBuyPageFormProductFragment_productOptions_edges_node_CheckboxOption | ClosetDesignBuyPageFormProductFragment_productOptions_edges_node_MultipleChoiceOption;
...
export interface ClosetDesignBuyPageFormProductFragment_productOptions {
   ...
   * A list of edges.
   */
  edges: (ClosetDesignBuyPageFormProductFragment_productOptions_edges | null)[] | null;
}

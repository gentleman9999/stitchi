...
export interface CatalogProductProductFragment_productOptions_edges_node_MultipleChoiceOption_values {
   ...
   */
  edges:
    | (CatalogProductProductFragment_productOptions_edges_node_MultipleChoiceOption_values_edges | null)[]
    | null
}
...
export type CatalogProductProductFragment_productOptions_edges_node =
  | CatalogProductProductFragment_productOptions_edges_node_CheckboxOption
  | CatalogProductProductFragment_productOptions_edges_node_MultipleChoiceOption

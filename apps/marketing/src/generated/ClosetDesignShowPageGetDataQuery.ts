...
export interface ClosetDesignShowPageGetDataQuery_designRequest_designRequestProducts_catalogProduct {
...
export interface ClosetDesignShowPageGetDataQuery_designRequest_designRequestProducts {
  ...
  id: string;
  catalogProduct: ClosetDesignShowPageGetDataQuery_designRequest_designRequestProducts_catalogProduct | null;
}

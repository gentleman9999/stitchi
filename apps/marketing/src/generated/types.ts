...
export type ProductFormProductFragment = { __typename: 'Product', id: string, entityId: number, name: string, sku: string, priceMetadata: { __typename: 'ProductPriceMetadata', minPriceCents: number, maxPriceCents: number }, brand: { __typename: 'Brand', id: string, name: string } | null, reviewSummary: { __typename: 'Reviews', numberOfReviews: number, summationOfRatings: number } };
...
export type ProductShowPageHeroProductFragment = { __typename: 'Product', id: string, entityId: number, name: string, path: string, sku: string, variants: { __typename: 'VariantConnection', edges: Array<{ __typename: 'VariantEdge', node: { __typename: 'Variant', id: string, entityId: number, options: { __typename: 'OptionConnection', edges: Array<{ __typename: 'OptionEdge', node: { __typename: 'ProductOption', displayName: string, values: { __typename: 'OptionValueConnection', edges: Array<{ __typename: 'OptionValueEdge', node: { __typename: 'ProductOptionValue', entityId: number, label: string } } | null> | null } } } | null> | null }, defaultImage: { __typename: 'Image', isDefault: boolean, url: string } | null } } | null> | null }, defaultImage: { __typename: 'Image', url: string } | null, images: { __typename: 'ImageConnection', edges: Array<{ __typename: 'ImageEdge', node: { __typename: 'Image', isDefault: boolean, url: string } } | null> | null }, priceMetadata: { __typename: 'ProductPriceMetadata', minPriceCents: number, maxPriceCents: number }, brand: { __typename: 'Brand', id: string, name: string } | null, reviewSummary: { __typename: 'Reviews', numberOfReviews: number, summationOfRatings: number }, productOptions: { __typename: 'ProductOptionConnection', edges: Array<{ __typename: 'ProductOptionEdge', node: { __typename: 'CheckboxOption', entityId: number } | { __typename: 'DateFieldOption', entityId: number } | { __typename: 'FileUploadFieldOption', entityId: number } | { __typename: 'MultiLineTextFieldOption', entityId: number } | { __typename: 'MultipleChoiceOption', displayName: string, entityId: number, values: { __typename: 'ProductOptionValueConnection', edges: Array<{ __typename: 'ProductOptionValueEdge', node: { __typename: 'MultipleChoiceOptionValue', entityId: number, label: string } | { __typename: 'ProductPickListOptionValue', entityId: number, label: string } | { __typename: 'SwatchOptionValue', hexColors: Array<string>, entityId: number, label: string } } | null> | null } } | { __typename: 'NumberFieldOption', entityId: number } | { __typename: 'TextFieldOption', entityId: number } } | null> | null } };

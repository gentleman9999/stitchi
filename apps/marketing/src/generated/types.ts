...
export interface DesignProduct {
  ...
  minUnitPriceCents: Maybe<Scalars['Int']['output']>;
  name: Scalars['String']['output'];
...
export interface DesignProductquoteArgs {
  quantity: Scalars['Int']['input'];
}
...
export type PageSectionModelContentField = FaqGroupRecord | FeatureGridRecord;
...
/** Product */
export interface ProductquoteArgs {
...
export type UseFilterPreviewGetDataQuery = { __typename: 'Query', site: { __typename: 'Site', search: { __typename: 'SearchQueries', searchProducts: { __typename: 'SearchProducts', products: { __typename: 'ProductConnection', collectionInfo: { __typename: 'CollectionInfo', totalItems: any | null } | null } } } } };

export type CatalogProductGridSiteFragment = { __typename: 'Site', search: { __typename: 'SearchQueries', searchProducts: { __typename: 'SearchProducts', products: { __typename: 'ProductConnection', edges: Array<{ __typename: 'ProductEdge', node: { __typename: 'Product', id: string, entityId: number, name: string, path: string, priceCents: number, brand: { __typename: 'Brand', id: string, name: string, path: string } | null, defaultImage: { __typename: 'Image', urlOriginal: string, altText: string, url: string } | null, productOptions: { __typename: 'ProductOptionConnection', edges: Array<{ __typename: 'ProductOptionEdge', node: { __typename: 'CheckboxOption', entityId: number } | { __typename: 'DateFieldOption', entityId: number } | { __typename: 'FileUploadFieldOption', entityId: number } | { __typename: 'MultiLineTextFieldOption', entityId: number } | { __typename: 'MultipleChoiceOption', displayName: string, entityId: number, values: { __typename: 'ProductOptionValueConnection', edges: Array<{ __typename: 'ProductOptionValueEdge', node: { __typename: 'MultipleChoiceOptionValue', entityId: number, label: string } | { __typename: 'ProductPickListOptionValue', entityId: number, label: string } | { __typename: 'SwatchOptionValue', hexColors: Array<string>, entityId: number, label: string } } | null> | null } } | { __typename: 'NumberFieldOption', entityId: number } | { __typename: 'TextFieldOption', entityId: number } } | null> | null } } } | null> | null, pageInfo: { __typename: 'PageInfo', hasNextPage: boolean, endCursor: string | null } } } } };

export type CatalogProductProductFragment = { __typename: 'CatalogProduct', id: string, name: string, slug: string, priceCents: number };
...
export type CatalogProductVariantPreviewProductFragment = { __typename: 'Product', id: string, name: string, defaultImage: { __typename: 'Image', url: string } | null, images: { __typename: 'ImageConnection', edges: Array<{ __typename: 'ImageEdge', node: { __typename: 'Image', isDefault: boolean, url: string } } | null> | null }, variants: { __typename: 'VariantConnection', edges: Array<{ __typename: 'VariantEdge', node: { __typename: 'Variant', id: string, entityId: number, defaultImage: { __typename: 'Image', isDefault: boolean, url: string } | null } } | null> | null }, productOptions: { __typename: 'ProductOptionConnection', edges: Array<{ __typename: 'ProductOptionEdge', node: { __typename: 'CheckboxOption', entityId: number } | { __typename: 'DateFieldOption', entityId: number } | { __typename: 'FileUploadFieldOption', entityId: number } | { __typename: 'MultiLineTextFieldOption', entityId: number } | { __typename: 'MultipleChoiceOption', displayName: string, entityId: number, values: { __typename: 'ProductOptionValueConnection', edges: Array<{ __typename: 'ProductOptionValueEdge', node: { __typename: 'MultipleChoiceOptionValue', entityId: number, label: string } | { __typename: 'ProductPickListOptionValue', entityId: number, label: string } | { __typename: 'SwatchOptionValue', hexColors: Array<string>, entityId: number, label: string } } | null> | null } } | { __typename: 'NumberFieldOption', entityId: number } | { __typename: 'TextFieldOption', entityId: number } } | null> | null } };
...
export type IndustriesIndexPageGetPathDataQuery = { __typename: 'Query', allLandingPages: Array<{ __typename: 'LandingPageRecord', id: any, slug: string | null }> };
...
export type CmsLandingPageCatalogSectionGetDataQueryVariables = Exact<{
  categoryId: Scalars['Int']['input'];
}>;


export type CmsLandingPageCatalogSectionGetDataQuery = { __typename: 'Query', site: { __typename: 'Site', category: { __typename: 'Category', id: string, products: { __typename: 'ProductConnection', edges: Array<{ __typename: 'ProductEdge', node: { __typename: 'Product', id: string, name: string, path: string, priceCents: number, brand: { __typename: 'Brand', id: string, name: string, path: string } | null, defaultImage: { __typename: 'Image', urlOriginal: string, altText: string, url: string } | null, productOptions: { __typename: 'ProductOptionConnection', edges: Array<{ __typename: 'ProductOptionEdge', node: { __typename: 'CheckboxOption', entityId: number } | { __typename: 'DateFieldOption', entityId: number } | { __typename: 'FileUploadFieldOption', entityId: number } | { __typename: 'MultiLineTextFieldOption', entityId: number } | { __typename: 'MultipleChoiceOption', displayName: string, entityId: number, values: { __typename: 'ProductOptionValueConnection', edges: Array<{ __typename: 'ProductOptionValueEdge', node: { __typename: 'MultipleChoiceOptionValue', entityId: number, label: string } | { __typename: 'ProductPickListOptionValue', entityId: number, label: string } | { __typename: 'SwatchOptionValue', hexColors: Array<string>, entityId: number, label: string } } | null> | null } } | { __typename: 'NumberFieldOption', entityId: number } | { __typename: 'TextFieldOption', entityId: number } } | null> | null } } } | null> | null } } | null } };
...
export type CmsLandingPageSectionSectionFragment = { __typename: 'PageSectionRecord', id: any, title: string | null, subtitle: string | null, gutter: string | null, textAlignment: string | null, imageAlignment: string | null, image: { __typename: 'FileField', id: any, responsiveImage: { __typename: 'ResponsiveImage', srcSet: string, webpSrcSet: string, sizes: string, src: string, width: any, height: any, aspectRatio: any, alt: string | null, title: string | null, base64: string | null } | null } | null, content: Array<{ __typename: 'FaqGroupRecord', id: any, expandAll: any | null, faqs: Array<{ __typename: 'FaqRecord', id: any, question: string | null, answer: string | null }> } | { __typename: 'FeatureGridRecord', id: any, features: Array<{ __typename: 'FeatureGridFeatureRecord', id: any, name: string | null, shortDescription: string | null, callToActionText: string | null, callToActionUrl: string | null, icon: Array<{ __typename: 'HeroIconRecord', id: any, tag: string | null }> }> }> };
...
export type AppTopbarMembershipFragment = { __typename: 'Membership', id: string, humanizedRole: string | null, organization: { __typename: 'Organization', id: string, name: string | null }, user: { __typename: 'User', id: string, name: string | null, email: string | null, picture: string | null } | null };

export type AppTopbarUserMembershipFragment = { __typename: 'Membership', id: string, humanizedRole: string | null, organization: { __typename: 'Organization', id: string, name: string | null }, user: { __typename: 'User', id: string, name: string | null, email: string | null, picture: string | null } | null };

export type CatalogLayoutGetDataQueryVariables = Exact<{ [key: string]: never; }>;


export type CatalogLayoutGetDataQuery = { __typename: 'Query', viewer: { __typename: 'Membership', id: string, humanizedRole: string | null, organization: { __typename: 'Organization', id: string, name: string | null }, user: { __typename: 'User', id: string, name: string | null, email: string | null, picture: string | null } | null } | null };

export type ClosetLayoutGetDataQueryVariables = Exact<{ [key: string]: never; }>;


export type ClosetLayoutGetDataQuery = { __typename: 'Query', viewer: { __typename: 'Membership', id: string, unseenWebNotificationsCount: number, humanizedRole: string | null, organization: { __typename: 'Organization', id: string, name: string | null }, user: { __typename: 'User', id: string, name: string | null, email: string | null, picture: string | null } | null } | null };

export type ClosetLayoutNavigationMembershipFragment = { __typename: 'Membership', id: string, unseenWebNotificationsCount: number };
...
export type BlogPostIndexPageCategoryFragment = { __typename: 'CategoryRecord', id: any, name: string | null, shortName: string | null, slug: string | null, description: { __typename: 'CategoryModelDescriptionField', value: any } | null, _seoMetaTags: Array<{ __typename: 'Tag', attributes: any | null, content: string | null, tag: string }> };

export type BlogPostIndexPagePageFragment = { __typename: 'BlogIndexPageRecord', id: any, _seoMetaTags: Array<{ __typename: 'Tag', attributes: any | null, content: string | null, tag: string }> };

export type BlogPostIndexPageSeoCategoryFragment = { __typename: 'CategoryRecord', id: any, slug: string | null, _seoMetaTags: Array<{ __typename: 'Tag', attributes: any | null, content: string | null, tag: string }> };
...
export type BrandShowPageBrandFragment = { __typename: 'Brand', id: string, entityId: number, name: string, path: string, defaultImage: { __typename: 'Image', url: string } | null, seo: { __typename: 'SeoDetails', pageTitle: string, metaDescription: string } };
...
export type CategoryShowPageCategoryFragment = { __typename: 'Category', id: string, entityId: number, name: string, description: string, path: string, seo: { __typename: 'SeoDetails', metaDescription: string } };
...
export type ClosetDesignRequestShowPageGetDataQueryVariables = Exact<{
  designId: Scalars['ID']['input'];
}>;
...
export type CreateDesignSlideOverGetDataQueryVariables = Exact<{
  designProofId: Scalars['ID']['input'];
}>;


export type CreateDesignSlideOverGetDataQuery = { __typename: 'Query', designProof: { __typename: 'DesignProof', id: string, primaryImageFile: { __typename: 'FileImage', id: string, url: string, width: number, height: number } | null } | null };

export type CreateDesignSlideOverGetDesignDataQueryVariables = Exact<{
  designId: Scalars['ID']['input'];
}>;


export type CreateDesignSlideOverGetDesignDataQuery = { __typename: 'Query', designProduct: { __typename: 'DesignProduct', id: string, name: string, description: string | null, primaryImageFile: { __typename: 'FileImage', id: string, url: string, width: number, height: number } | null } | null };

export type CreateDesignSlideOverDesignRequestFragment = { __typename: 'DesignRequest', id: string, name: string };

export type UseCreateDesignSildeOverApproveDesignMutationVariables = Exact<{
  input: DesignRequestApproveInput;
}>;


export type UseCreateDesignSildeOverApproveDesignMutation = { __typename: 'Mutation', designRequestApprove: { __typename: 'DesignRequestApprovePayload', designRequest: { __typename: 'DesignRequest', id: string } | null, design: { __typename: 'DesignProduct', id: string } | null } | null };
...
export type DesignRequestActivityGetDataQuery = { __typename: 'Query', designRequest: { __typename: 'DesignRequest', id: string, status: DesignRequestStatus, fileUploadDirectory: string, history: Array<{ __typename: 'ConversationMessage', id: string, message: string, createdAt: any, viewerIsSender: boolean, files: Array<{ __typename: 'FileImage', url: string, width: number, height: number, id: string } | { __typename: 'FilePdf', id: string } | { __typename: 'FileUnknown', id: string }>, sender: { __typename: 'Membership', id: string, user: { __typename: 'User', id: string, picture: string | null, name: string | null } | null } | null } | { __typename: 'DesignProof', id: string, createdAt: any, artist: { __typename: 'Membership', id: string, user: { __typename: 'User', id: string, name: string | null } | null } | null, primaryImageFile: { __typename: 'FileImage', id: string, url: string, width: number, height: number } | null } | { __typename: 'DesignRequestHistoryItemDesignRequestEvent', id: string, timestamp: any, method: DesignRequestHistoryItemDesignRequestEventMethod, actor: { __typename: 'Membership', id: string, user: { __typename: 'User', id: string, name: string | null, picture: string | null } | null } | null } | { __typename: 'DesignRequestRevisionRequest', id: string, createdAt: any, description: string, files: Array<{ __typename: 'FileImage', url: string, width: number, height: number, id: string } | { __typename: 'FilePdf', id: string } | { __typename: 'FileUnknown', id: string }>, membership: { __typename: 'Membership', id: string, user: { __typename: 'User', id: string, name: string | null } | null } | null }>, membership: { __typename: 'Membership', id: string, user: { __typename: 'User', id: string, name: string | null, picture: string | null } | null } | null } | null };

export type DesignRequestHistoryDesignRequestFragment = { __typename: 'DesignRequest', id: string, history: Array<{ __typename: 'ConversationMessage', id: string, message: string, createdAt: any, viewerIsSender: boolean, files: Array<{ __typename: 'FileImage', url: string, width: number, height: number, id: string } | { __typename: 'FilePdf', id: string } | { __typename: 'FileUnknown', id: string }>, sender: { __typename: 'Membership', id: string, user: { __typename: 'User', id: string, picture: string | null, name: string | null } | null } | null } | { __typename: 'DesignProof', id: string, createdAt: any, artist: { __typename: 'Membership', id: string, user: { __typename: 'User', id: string, name: string | null } | null } | null, primaryImageFile: { __typename: 'FileImage', id: string, url: string, width: number, height: number } | null } | { __typename: 'DesignRequestHistoryItemDesignRequestEvent', id: string, timestamp: any, method: DesignRequestHistoryItemDesignRequestEventMethod, actor: { __typename: 'Membership', id: string, user: { __typename: 'User', id: string, name: string | null, picture: string | null } | null } | null } | { __typename: 'DesignRequestRevisionRequest', id: string, createdAt: any, description: string, files: Array<{ __typename: 'FileImage', url: string, width: number, height: number, id: string } | { __typename: 'FilePdf', id: string } | { __typename: 'FileUnknown', id: string }>, membership: { __typename: 'Membership', id: string, user: { __typename: 'User', id: string, name: string | null } | null } | null }> };

export type DesignRequestMessageInputDesignRequestFragment = { __typename: 'DesignRequest', id: string, fileUploadDirectory: string, membership: { __typename: 'Membership', id: string, user: { __typename: 'User', id: string, name: string | null, picture: string | null } | null } | null };
...
export type DesignRequestDraftDesignRequestFragments = { __typename: 'DesignRequest', id: string, fileUploadDirectory: string, useCase: string | null, fileIds: Array<string>, designRequestLocations: Array<{ __typename: 'DesignRequestDesignLocation', id: string, description: string | null, placement: string | null, fileIds: Array<string> }>, files: Array<{ __typename: 'FileImage', width: number, height: number, id: string, humanizedBytes: string, name: string, url: string, fileType: FileType } | { __typename: 'FilePdf', id: string, humanizedBytes: string, name: string, url: string, fileType: FileType } | { __typename: 'FileUnknown', id: string, humanizedBytes: string, name: string, url: string, fileType: FileType }> };

export type AdditionalInformationFormDesignRequestFragment = { __typename: 'DesignRequest', id: string, files: Array<{ __typename: 'FileImage', width: number, height: number, id: string, humanizedBytes: string, name: string, url: string, fileType: FileType } | { __typename: 'FilePdf', id: string, humanizedBytes: string, name: string, url: string, fileType: FileType } | { __typename: 'FileUnknown', id: string, humanizedBytes: string, name: string, url: string, fileType: FileType }> };

export type UseDesignRequestDraftUpdateDesignRequestMutationVariables = Exact<{
  input: DesignRequestUpdateInput;
}>;


export type UseDesignRequestDraftUpdateDesignRequestMutation = { __typename: 'Mutation', designRequestUpdate: { __typename: 'DesignRequestUpdatePayload', designRequest: { __typename: 'DesignRequest', id: string } | null } | null };
...
export type DesignRequestOverviewGetDataQuery = { __typename: 'Query', designRequest: { __typename: 'DesignRequest', id: string, status: DesignRequestStatus, fileUploadDirectory: string, useCase: string | null, fileIds: Array<string>, description: string | null, name: string, proofs: Array<{ __typename: 'DesignProof', id: string }>, designRequestProduct: { __typename: 'DesignRequestProduct', id: string, colors: Array<{ __typename: 'DesignRequestProductColors', hexCode: string | null, name: string | null }>, catalogProduct: { __typename: 'CatalogProduct', id: string, name: string, slug: string, primaryImage: { __typename: 'CatalogProductImage', url: string } | null, brand: { __typename: 'CatalogBrand', id: string, name: string, slug: string } | null } | null }, orders: Array<{ __typename: 'Order', id: string, humanOrderId: string }>, designRequestLocations: Array<{ __typename: 'DesignRequestDesignLocation', id: string, description: string | null, placement: string | null, fileIds: Array<string>, files: Array<{ __typename: 'FileImage', width: number, height: number, id: string, humanizedBytes: string, name: string, url: string, fileType: FileType } | { __typename: 'FilePdf', id: string, humanizedBytes: string, name: string, url: string, fileType: FileType } | { __typename: 'FileUnknown', id: string, humanizedBytes: string, name: string, url: string, fileType: FileType }> }>, files: Array<{ __typename: 'FileImage', width: number, height: number, id: string, humanizedBytes: string, name: string, url: string, fileType: FileType } | { __typename: 'FilePdf', id: string, humanizedBytes: string, name: string, url: string, fileType: FileType } | { __typename: 'FileUnknown', id: string, humanizedBytes: string, name: string, url: string, fileType: FileType }> } | null };
...
export type ClosetInventoryShowPageGetDataQueryVariables = Exact<{
  designId: Scalars['ID']['input'];
}>;


export type ClosetInventoryShowPageGetDataQuery = { __typename: 'Query', designProduct: { __typename: 'DesignProduct', id: string, designRequestId: string, name: string } | null };
...
export type DesignLibraryCategoryIndexPageCategoryFragment = { __typename: 'DesignCategoryRecord', id: any, slug: string | null, name: string | null };

export type DesignLibraryCategoryShowPageCatalogFragment = { __typename: 'Site', featuredProducts: { __typename: 'ProductConnection', edges: Array<{ __typename: 'ProductEdge', node: { __typename: 'Product', id: string, name: string, path: string, brand: { __typename: 'Brand', id: string, path: string } | null, defaultImage: { __typename: 'Image', url: string } | null } } | null> | null } };
...
export type OrderDetailsPageLineItemsItemFragment = { __typename: 'OrderItem', id: string, title: string, quantity: number, unitPriceCents: number, totalPriceCents: number };
...
export type ProductFormGetProductQuoteQueryVariables = Exact<{
...
export type ProductFormGetProductQuoteQuery = { __typename: 'Query', site: { __typename: 'Site', product: { __typename: 'Product', id: string, quote: { __typename: 'Quote', id: string, productUnitCostCents: number } } | null } };

export type ProductFormGetProductQuoteMaxQueryVariables = Exact<{
  productId: Scalars['ID']['input'];
}>;


export type ProductFormGetProductQuoteMaxQuery = { __typename: 'Query', site: { __typename: 'Site', product: { __typename: 'Product', id: string, maxQuote: { __typename: 'Quote', id: string, productUnitCostCents: number } } | null } };
...
export type ProductPageGetDesignCategoryData = { __typename: 'Query', site: { __typename: 'Site', featuredProducts: { __typename: 'ProductConnection', edges: Array<{ __typename: 'ProductEdge', node: { __typename: 'Product', id: string, name: string, path: string, brand: { __typename: 'Brand', id: string, path: string } | null, defaultImage: { __typename: 'Image', url: string } | null } } | null> | null } }, designCategory: { __typename: 'DesignCategoryRecord', id: any, name: string | null, slug: string | null, _seoMetaTags: Array<{ __typename: 'Tag', attributes: any | null, content: string | null, tag: string }>, _allReferencingDesigns: Array<{ __typename: 'DesignRecord', id: any, primaryImage: { __typename: 'FileField', id: any, responsiveImage: { __typename: 'ResponsiveImage', srcSet: string, webpSrcSet: string, sizes: string, src: string, width: any, height: any, aspectRatio: any, alt: string | null, title: string | null, base64: string | null } | null } | null }> } | null };
...
export type ClosetInboxIndexPageGetDataQueryVariables = Exact<{
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
...
export type ClosetInboxIndexPageGetDataQuery = { __typename: 'Query', viewer: { __typename: 'Membership', id: string, unseenWebNotificationsCount: number, notifications: { __typename: 'NotificationConnection', edges: Array<{ __typename: 'NotificationEdge', node: { __typename: 'Notification', id: string, createdAt: any, channels: Array<{ __typename: 'NotificationChannelEmail', id: string } | { __typename: 'NotificationChannelWeb', message: string, ctaText: string | null, ctaUrl: string | null, seenAt: any | null, id: string } | null> } | null } | null> | null, pageInfo: { __typename: 'PageInfo', hasNextPage: boolean, hasPreviousPage: boolean, endCursor: string | null, startCursor: string | null } } | null } | null };
...
export type DesignLibraryCategoryIndexPageQueryVariables = Exact<{ [key: string]: never; }>;


export type DesignLibraryCategoryIndexPageQuery = { __typename: 'Query', allDesignCategories: Array<{ __typename: 'DesignCategoryRecord', id: any, slug: string | null, name: string | null }> };

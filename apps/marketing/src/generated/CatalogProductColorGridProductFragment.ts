...
export type CatalogProductColorGridProductFragment_productOptions_edges_node_MultipleChoiceOption_values_edges_node = CatalogProductColorGridProductFragment_productOptions_edges_node_MultipleChoiceOption_values_edges_node_MultipleChoiceOptionValue | CatalogProductColorGridProductFragment_productOptions_edges_node_MultipleChoiceOption_values_edges_node_SwatchOptionValue;
...
export interface CatalogProductColorGridProductFragment_productOptions_edges_node_MultipleChoiceOption_values {
   ...
   * A list of edges.
   */
  edges: (CatalogProductColorGridProductFragment_productOptions_edges_node_MultipleChoiceOption_values_edges | null)[] | null;
}
...
export type CatalogProductColorGridProductFragment_productOptions_edges_node = CatalogProductColorGridProductFragment_productOptions_edges_node_CheckboxOption | CatalogProductColorGridProductFragment_productOptions_edges_node_MultipleChoiceOption;
...
export interface CatalogProductColorGridProductFragment_productOptions {
   ...
   * A list of edges.
   */
  edges: (CatalogProductColorGridProductFragment_productOptions_edges | null)[] | null;
}

...
const DistributorPageHero = () => {
  ...
  return (
    <div className="min-h-screen flex items-center bg-midnight">
      <Container>
        <Section gutter="xl">
          <div className="mt-10 flex flex-col sm:flex-row gap-8 md:gap-10 lg:gap-12">
            ...
            <div className="flex-1 min-w-[300px]">
              <div className="ring-2 ring-primary rounded-sm bg-white p-4 text-gray-800 shadow-gray-700 shadow-lg">

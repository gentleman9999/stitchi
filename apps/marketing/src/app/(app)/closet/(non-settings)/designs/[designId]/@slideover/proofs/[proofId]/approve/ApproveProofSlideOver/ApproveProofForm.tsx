...
interface Props {
  ...
  onSubmit: (values: FormValues) => any | Promise<any>
            ...
            render={({ field, fieldState }) => (
              ...
              >
                <p className="text-xs leading-1 text-gray-700">
                  ...
                  incorporated in the design. You also affirm that you have read
                  and agree to our{' '}
                  <LinkInline
...
export default ApproveProofForm

...
import { ArrowRight, GlobalDistribution2, Link } from 'icons'
...
import useCalculatorFormQuote from '../ProductShowPage/ProductShowPageHero/CalculatorForm/useCalculatorFormQuote'
...
interface Props {
  ...
  onSubmit: (data: FormInput) => Promise<void> | void
}

const Form = ({ onSubmit, productVariantEntityId }: Props) => {
  ...
  const [getQuote, { data }] = useCalculatorFormQuote({
    catalogProductVariantId: productVariantEntityId,
  })

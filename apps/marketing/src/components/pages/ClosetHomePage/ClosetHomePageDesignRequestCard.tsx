...
import { ClosetHomePageDesignRequestCardDesignRequestFragment } from '@generated/ClosetHomePageDesignRequestCardDesignRequestFragment'
...
interface Props {
  designRequest: ClosetHomePageDesignRequestCardDesignRequestFragment
}

const ClosetHomePageDesignRequestCard = ({ designRequest }: Props) => {
  return (
    <Link
      className="relative col-span-1 rounded-md overflow-hidden shadow-sm border"
...
ClosetHomePageDesignRequestCard.fragments = {
  designRequest: gql`
    fragment ClosetHomePageDesignRequestCardDesignRequestFragment on DesignRequest {
      id
      name
      updatedAt
      status
...
export default ClosetHomePageDesignRequestCard

...
const imageProps = {
  className:
    'rounded-md border border-gray-800 shadow-magical max-w-[300px] max-h-[300px] md:max-w-[350px] md:max-h-[350px] lg:max-w-none lg:max-h-none lg:w-full',
}
...
const HomePageFeaturedImages = (props: Props) => {
  return (
    <div className="py-10">
      <div className="flex flex-row justify-center lg:gap-8 w-screen overflow-hidden h-[85vh] md:max-h-screen md:h-[650px] lg:h-[600px] xl:h-[800px]">

...
const DesignPageAdvantages = () => {
  return (
    <Section gutter="sm">
      ...
      <div className="shadow-xl rounded-2xl overflow-hidden mt-6">
        <Image
          src={closetRendering}
          layout="intrinsic"
        ...
        <div className="bg-secondaryAlt-200 py-6 px-4 md:py-10 md:px-8 grid grid-cols-1 sm:grid-cols-3 gap-4 lg:gap-10 mt-8">
          <Item

...
type TemplateVariables = Product & {
      ...
      const outputParser = StructuredOutputParser.fromZodSchema(
        z.object({
          html: z
            ...
            .endsWith('>')
            .describe(
              'HTML, without any plaintext or markdown. Avoid using the <h1> tag.',
            ),
        }),
      )

      const prompt = ChatPromptTemplate.fromMessages<TemplateVariables>([
